...
CONFIG=$3
RefAligner=$tools/pipeline/Solve3.6.1_11162020/RefAligner/11442.11643rel/RefAligner
...
echo "\
perl $tools/pipeline/Solve3.6.1_11162020/HybridScaffold/11162020/hybridScaffold.pl \
  -n $ASM \
  -b $BMAP \
	-c $CONFIG \
	-r $RefAligner \
