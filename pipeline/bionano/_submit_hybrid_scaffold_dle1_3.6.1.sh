...
if [ -z $1 ]; then
	echo "Usage: ./_submit_hybrid_scaffold_dle1_3.6.1.sh <name>"
...
partition=largemem
name=$1
script=$VGP_PIPELINE/bionano/hybrid_scaffold_3.6.1.sh
args="$1 DLE1 $VGP_PIPELINE/bionano/hybridScaffold_DLE1_config_3.6.1.xml"
walltime=4-0
